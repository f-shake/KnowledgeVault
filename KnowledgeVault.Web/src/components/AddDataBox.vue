<template>
  ...
  >
    ...
    >
      <el-input
        v-model="paperInsert.journal"
        placeholder="如基金委面上、青年等"
      />
    </el-form-item>
    <el-form-item
      label="负责老师"
    ...
    >
      <el-input
        v-model="paperInsert.executionTime"
        placeholder="格式要求如：2024-05-01"
      />
    </el-form-item>
    <el-form-item
      label="金额（万元)"
  ...
  <el-button
    type="primary"
    @click="onSubmit"
    :disabled="!isUploadComplete || isSubmitting"
  >
    {{ isSubmitting ? '保存中...' : '保存' }}
  </el-button>
