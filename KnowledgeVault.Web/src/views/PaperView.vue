    ...
    <div style="display: flex; height:100%; flex-direction: column;">
        ...
        <div class="search">
            <el-form :inline="true" v-model="itemSelect" class="demo-form-inline">
                ...
                <el-form-item label="类型">
                    <el-select v-model="itemSelect.subType" placeholder="请选择成果类型" clearable style="width: 160px;">
        ...
        <el-table :data="paperData" v-loading="loading" highlight-current-row stripe border show-overflow-tooltip
            ...
            :index="indexMethod(itemSelect.PageIndex, itemSelect.PageSize)"
                width="60" />
            <el-table-column label="论文题目" prop="title" min-width="200" />
            <el-table-column sortable="custom" label="老师" prop="correspond" />
            <el-table-column sortable="custom" label="学生" prop="firstAuthor" />
            <el-table-column sortable="custom" label="期刊" prop="journal" min-width="160" />
